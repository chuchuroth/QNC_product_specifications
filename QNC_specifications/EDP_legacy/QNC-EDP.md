...
| **ICD v3.0** | Dual API surfaces; semantic core binding; DDS Pack optional; discovery → protocol matrices; fault_domain isolation |
| **DPS v2.0** | YAML-only normative; `semantic_mapping`; DDS expunged from profiles; fault source_layer DDS removal |
